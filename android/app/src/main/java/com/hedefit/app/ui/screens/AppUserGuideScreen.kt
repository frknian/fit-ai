...
private val guideSections = listOf(
    ...
    GuideSection("home", Icons.Default.Home, "Ana ekran", "Home", "Günün önemli bilgilerini tek yerde gösterir.", "Shows the most important information for your day.",
        listOf("Sağ üstte, bildirim simgesinin yanındaki takvim düğmesi antrenman takvimini açar; antrenmanını bir güne ve saate buradan planlayabilirsin.", "Hedef yolculuğu kartı mevcut durumunu, hedefini ve tahmini süreni gösterir.", "Rota kartından yürüyüş, koşu veya bisiklet kaydını başlatabilirsin.", "Adım, aktif kalori ve su kartlarına dokunarak ayrıntıları ve günlük hedefleri açabilirsin.", "Programlar bölümündeki + düğmesiyle yalnız istediğin programları ana ekranda gösterebilirsin."),
        listOf("The calendar button beside Notifications in the top-right opens the workout calendar; schedule a workout for a day and time there.", "The goal journey card shows your current state, target and estimated timeline.", "Start a walk, run or ride from the Route card.", "Tap steps, active calories or water to open details and daily targets.", "Use + in Programs to choose which programs appear on Home.")),
    GuideSection("workout", Icons.Default.FitnessCenter, "Programlar ve antrenman", "Programs and workouts", "OpenAI programı, bölgesel plan veya kendi programını kullanabilirsin.", "Use an OpenAI plan, a regional plan or your own program.",
        listOf("Antrenman sekmesinde aktif programını seç, yeni program oluştur veya bölgeye göre program üret.", "Antrenman planlamak için Ana Sayfa'nın sağ üstündeki takvim düğmesini kullan.", "Başla düğmesi set ekranını açar. Her sette kilo, tekrar, süre ve algılanan zorluk bilgilerini kaydedebilirsin.", "Bitirirken zorluk, yorgunluk ve ağrı geri bildirimi ver; sonraki plan uyarlamasında bu bilgiler kullanılır.", "Program içindeki hareketleri değiştirebilir, silebilir veya sıralayabilirsin. Kayıtlı geçmişin silinmez."),
        listOf("Choose your active plan, create a program or generate a body-part plan in Workout.", "Use the calendar button in the top-right of Home to schedule a workout.", "Start opens set tracking. Log weight, repetitions, duration and perceived effort for each set.", "At the end, report difficulty, fatigue and pain; these signals help adapt the next plan.", "Replace, remove or reorder exercises without deleting completed history.")),
    ...
    GuideSection("nutrition", Icons.Default.Restaurant, "Beslenme ve su", "Nutrition and water", "Öğünlerini, makrolarını ve su tüketimini günlük takip et.", "Track meals, macros and water each day.",
        listOf("Yemek adını veya tarifi yazarak AI ile tahmin oluşturabilir ya da besin kataloğunda arayabilirsin.", "Porsiyon gramını ve öğünü seç; kalori, protein, karbonhidrat ve yağ miktarı buna göre hesaplanır.", "Kayıtları düzenleyebilir, silebilir, favoriye alabilir ve favoriyi tekrar ekleyebilirsin.", "Tarih seçiciyle geçmiş günleri incele. Su kartından miktar ekle ve günlük su hedefini değiştir.", "AI besin değerleri tahmindir; ambalaj etiketi veya uzman planı varsa onu esas al."),
        listOf("Type a food or recipe for an AI estimate, or search the food catalog.", "Choose grams and meal; calories, protein, carbs and fat scale to the serving.", "Edit, delete, favorite and repeat entries.", "Use the date picker for past days. Add water and change the daily water goal from the water card.", "AI nutrition values are estimates; prefer labels or a professional plan when available.")),
