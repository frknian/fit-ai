...
const labelsTr: Record<string, string> = {
  abdominals: "Karın",
  abductors: "Dış kalça (abdüktör)",
  adductors: "İç uyluk (addüktör)",
  biceps: "Ön kol (biseps)",
  calves: "Baldır (gastroknemius)",
  chest: "Göğüs",
  forearms: "Bilek ve ön kol",
  glutes: "Kalça (gluteal)",
  hamstrings: "Arka uyluk (hamstring)",
  lats: "Kanat sırtı (lat)",
  "lower back": "Bel (erektör spinae)",
  "middle back": "Orta sırt (romboid)",
  quadriceps: "Ön uyluk (kuadriseps)",
  shoulders: "Omuz (deltoid)",
  traps: "Trapez",
